...
const Navbar = () => {
  ...
  return (
    <nav
      className={cn(
        'fixed top-0 left-0 right-0 z-50 transition-all duration-600 py-4 px-6 w-full md:w-1/2 md:mx-auto bg-dark-100/80 backdrop-blur-md shadow-md rounded-full mt-2   border border-white/10',
    ...
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <Button
          variant="ghost"
          size="icon"
          className="md:hidden text-white hover:bg-dark-200"
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            className="md:hidden absolute top-full left-0 right-0 bg-dark-100/95 backdrop-blur-md p-4 flex flex-col gap-4 border-t border-white/10"
          >
            <NavLinks mobile />
